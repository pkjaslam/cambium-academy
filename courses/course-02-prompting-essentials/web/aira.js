...
(function(){
  ...
  function advise(){
    var s = read("cambium-c02-slides") || {}, seen = s.seen || 0;
    var lecture = seen >= 40 || !!(read("cambium-c02-lecture") || {}).watched;
    ...
    var quiz = read("cambium-c02-quiz") || {}, cert = read("cambium-c02-cert") || {};
    if (cert.issued) return { k: "next-certdone", t: "You have finished Course 02, Prompting Essentials, certificate and all. Post it on the graduate wall, try the capstone if you have not, and I will see you next week for the next Cambium Academy course.", href: "community.html", label: "Visit the community" };
