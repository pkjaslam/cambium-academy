...
(function(){
  var COURSE = "Prompting Essentials (Cambium Academy Course 02)";
  var ORG_ID = "133384582"; // linkedin.com/company/cambium-ai-institute
  var LANDER = "https://pkjaslam.github.io/cambium-academy/start/";
  var CERTURL = "https://pkjaslam.github.io/cambium-academy/courses/course-02-prompting-essentials/web/certificate.html";
  ...
  var timer = setInterval(function(){
    ...
    var m = (document.body.innerText || "").match(/CAMB-C02-[A-Z0-9]{6}/);
  ...
  function init(cert, certId){
    ...
    var shareText = "I just earned the Prompting Essentials certificate from Cambium AI Institute. Free, hands-on, and the quiz stays locked until you actually study. Join the founding cohort: " + LANDER;
    ...
    document.getElementById("badgeBtn").onclick = function(){
      ...
      function finish(){
        ...
        c.fillText("PROMPTING ESSENTIALS", cx, cy + 40);
        ...
        try {
          ...
          a.download = "cambium-academy-prompting-essentials-badge.png";
      ...
      function bakeOpenBadge(canvas){
        var BASE = "https://pkjaslam.github.io/cambium-academy/courses/course-02-prompting-essentials/web/";
        ...
        var assertion = {
          ...
          "badge": BASE + "badges/course-02-prompting-essentials.json",
          "issuedOn": issued,
    ...
    setTimeout(function(){
      try {
        ...
        if (localStorage.getItem("cambium-c02-registered") === certId) return;
        var learner = rd("cambium-c02-learner") || {};
        fetch(reg.endpoint, {
          method: "POST",
          mode: "no-cors",
          headers: { "Content-Type": "text/plain" },
          body: JSON.stringify({ course: "C02", name: cert.name, org: cert.org || "", email: learner.email || "", certId: certId, date: cert.date || "", score: cert.score || "" })
        }).then(function(){ localStorage.setItem("cambium-c02-registered", certId); }).catch(function(){});
      } catch(e) {}
    }, 800);
  }
})();
