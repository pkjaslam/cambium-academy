...
1. RESOLVED 2026-07-09: the exact persona figures (71.6/68.0/66.3 MMLU) are verified against the USC PRISM paper (arxiv.org/abs/2603.18507); Wharton 2512.05858 corroborates the direction. The earlier 2605.29420 citation was wrong (no MMLU numbers in it) and has been corrected.
...
*Fact base: VERIFIED 2026-07-09 against the primary papers. The exact MMLU figures (71.6% baseline, 68.0% minimum persona, 66.3% long persona) come from Hu, Rostami and Thomason (USC), "Expert Personas Improve LLM Alignment but Damage Accuracy: Bootstrapping Intent-Based Persona Routing with PRISM," 19 Mar 2026 (arxiv.org/abs/2603.18507, Figure 1b and Section 3.1). The direction is corroborated by Wharton Generative AI Labs, Prompting Science Report 4, "Playing Pretend" (arxiv.org/pdf/2512.05858), which finds expert personas give no consistent accuracy benefit and, when they do change accuracy, are more likely to lower it, plus theregister.com/2026/03/24/ai_models_persona_prompting and knowledge.wharton.upenn.edu/article/why-you-shouldnt-ask-chatbots-to-act-like-an-expert. Caveat for camera: the 4-point drop is PRISM's average over small open-weight models on 5-shot MMLU; the direction (personas do not help facts, and can hurt) holds across all three sources. Earlier drafts wrongly attributed the numbers to arxiv 2605.29420, which contains no MMLU figures.*
...
1. DONE 2026-07-09: Slide 15's figures verified against the source papers. The 71.6/68.0/66.3 MMLU numbers are from the USC PRISM paper (arxiv.org/abs/2603.18507, Fig 1b / Sec 3.1); Wharton 2512.05858 corroborates the direction. Safe to speak as written (hedged as "about 72 to 68 percent, in one study").
