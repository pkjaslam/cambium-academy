...
(function(){
  var COURSE = "Building with AI (Cambium Academy Course 05)";
  var ORG_ID = "133384582"; // linkedin.com/company/cambium-ai-institute
  var LANDER = "https://pkjaslam.github.io/cambium-academy/start/";
  var CERTURL = "https://pkjaslam.github.io/cambium-academy/courses/course-05-building-with-ai/web/certificate.html";
  ...
  var timer = setInterval(function(){
    ...
    var m = (document.body.innerText || "").match(/CAMB-C05-[A-Z0-9]{6}/);
  ...
  function init(cert, certId){
    ...
    var shareText = "I just earned the Building with AI certificate from Cambium AI Institute: how to build agents that actually work and cannot hurt you when they fail. Scope well, wire well, test with evals, and supervise with least privilege and a human gate. Free, hands-on, and the quiz stays locked until you actually study. Join in: " + LANDER;
    ...
    document.getElementById("badgeBtn").onclick = function(){
      ...
      function finish(){
        c.textAlign = "center";
        c.fillStyle = "#FFFDF6"; c.font = "700 32px Georgia";
        c.fillText("BUILDING WITH AI", cx, cy + 40);
        ...
        try {
          ...
          a.download = "cambium-academy-building-with-ai-badge.png";
      ...
      function bakeOpenBadge(canvas){
        var BASE = "https://pkjaslam.github.io/cambium-academy/courses/course-05-building-with-ai/web/";
        ...
        var assertion = {
          ...
          "badge": BASE + "badges/course-05-building-with-ai.json",
          "issuedOn": issued,
          "verification": { "type": "HostedBadge" },
          "evidence": verifyUrl,
          "narrative": "Certificate ID " + certId + " issued after the full Cambium Academy learning path (lecture, 24 flashcards, five AI Lab games) and a quiz score of 70% or better."
        };
    ...
    setTimeout(function(){
      try {
        ...
        if (localStorage.getItem("cambium-c05-registered") === certId) return;
        var learner = rd("cambium-c05-learner") || {};
        fetch(reg.endpoint, {
          method: "POST",
          mode: "no-cors",
          headers: { "Content-Type": "text/plain" },
          body: JSON.stringify({ course: "C05", name: cert.name, org: cert.org || "", email: learner.email || "", certId: certId, date: cert.date || "", score: cert.score || "" })
        }).then(function(){ localStorage.setItem("cambium-c05-registered", certId); }).catch(function(){});
      } catch(e) {}
    }, 800);
  }
})();
