...
(function(){
  ...
  var SKEY = "cambium-c05-classroom";
  var store = rd(SKEY) || {};
  ...
  var LABNAMES = { scope: "Scope It", wire: "Wire It", break: "Break It", eval: "Eval It", blast: "Blast Radius" };
  function courseState(){
    var cards = rd("cambium-c05-cards") || {};
    var miss = rd("cambium-c05-cardmiss") || {};
    var pg = rd("cambium-c05-playground") || {};
    var quiz = rd("cambium-c05-quiz") || {};
    var slides = rd("cambium-c05-slides") || {};
    var lecture = rd("cambium-c05-lecture") || {};
    var cert = rd("cambium-c05-cert") || {};
    ...
    var labsLeft = ["scope","wire","break","eval","blast"].filter(function(k){ return !pg[k]; }).map(function(k){ return LABNAMES[k]; });
    var s = {
      name: (cert.name || learner.name || "").split(" ")[0] || "",
      slidesSeen: slides.seen || 0,
      lectureDone: (slides.seen || 0) >= 79 || !!lecture.watched,
  ...
  function nextStepText(s){
    ...
    if (!s.lectureDone) return "Finish the lecture first: " + (s.slidesSeen > 0 ? "you are " + s.slidesSeen + " of 79 slides in, keep going." : "start the slides above, about 50 minutes.");
  ...
  function snapshotLine(s){
    ...
    bits.push("slides " + Math.min(s.slidesSeen, 79) + "/79" + (s.lectureDone ? " (lecture done)" : ""));
  ...
  function greeting(){
    ...
    if (s.certIssued) bits.push("you have your certificate already, wonderful");
      ...
      else if (s.slidesSeen > 0) bits.push("you are " + s.slidesSeen + " of 79 slides in");
